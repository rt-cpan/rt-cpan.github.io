...
TCL_EXTRA_CFLAGS='-ggdb -O2 -pipe -Wimplicit-function-declaration -fdebug-prefix-map=/usr/src/ports/tcl/tcl-8.6.8-1.x86_64/build=/usr/src/debug/tcl-8.6.8-1 -fdebug-prefix-map=/usr/src/ports/tcl/tcl-8.6.8-1.x86_64/src/tcl8.6.8=/usr/src/debug/tcl-8.6.8-1 -pipe '
