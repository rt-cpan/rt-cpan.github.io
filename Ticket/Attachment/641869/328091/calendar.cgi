...
BEGIN
{
    ...
    no warnings; # prevent "Subroutine init redefined at calendar.cgi line 35." warning message
    sub init 
    {
        my($self)     = shift;
        ...
        my($profile)  = shift;
        my($language) = shift || 0;
        # Could be made a parameter of the init method in the future:
        my(@weekend)  = (5,1); # For example 1=Monday and 5=Friday
