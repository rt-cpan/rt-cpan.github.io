# This Makefile is for the DBD::ODBC extension to perl.
#
...
#     ABSTRACT => q[ODBC driver for the DBI module.]
#     AUTHOR => q[Tim Bunce, Jeff Urlwin, Martin J. Evans mailto:dbi-users@perl.org]
#     CONFIGURE => CODE(...)
#     DEFINE => q[ -DWITH_UNICODE]
#     INC => q[]
#     LIBS => [q[ODBC32.LIB]]
#     NAME => q[DBD::ODBC]
#     OBJECT => q[$(O_FILES)]
#     PREREQ_PM => { Test::Simple=>q[0.4], DBI=>q[1.21] }
#     PREREQ_PRINT => q[1]
#     SKIP => [q[processPL]]
#     VERSION_FROM => q[ODBC.pm]
#     clean => { FILES=>q[ODBC.xsi dbdodbc.h] }
#     dist => { DIST_DEFAULT=>q[clean distcheck tardist], COMPRESS=>q[gzip -v9], PREOP=>q[$(MAKE) -f Makefile.old distdir], SUFFIX=>q[gz] }
#     macro => { EXTRALIB=>q[ODBC32.LIB] }
...
INSTALLMAN1DIR = C:\strawberry\perl\man\man1
DESTINSTALLMAN1DIR = $(DESTDIR)$(INSTALLMAN1DIR)
INSTALLSITEMAN1DIR = $(INSTALLMAN1DIR)
DESTINSTALLSITEMAN1DIR = $(DESTDIR)$(INSTALLSITEMAN1DIR)
INSTALLVENDORMAN1DIR = 
DESTINSTALLVENDORMAN1DIR = $(DESTDIR)$(INSTALLVENDORMAN1DIR)
INSTALLMAN3DIR = C:\strawberry\perl\man\man3
...
XS_FILES = ODBC.xs
C_FILES  = ConvertUTF.c \
	ODBC.c \
	dbdimp.c \
	unicode_helper.c
O_FILES  = ConvertUTF.o \
	ODBC.o \
	dbdimp.o \
	unicode_helper.o
H_FILES  = ConvertUTF.h \
	ODBC.h \
	dbdimp.h \
	dbdodbc.h \
	dbivport.h \
...
ODBC.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"DBD::ODBC\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
OTHERLDFLAGS = -Wl,--image-base,0x61200000 
INST_DYNAMIC_DEP = 
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  ODBC.pm $(INST_MAN3DIR)\DBD\ODBC.$(MAN3EXT) 




# --- MakeMaker processPL section skipped.
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name:                DBD-ODBC" >> META_new.yml
	$(NOECHO) $(ECHO) "version:             1.15" >> META_new.yml
	$(NOECHO) $(ECHO) "abstract:            ODBC driver for the DBI module." >> META_new.yml
	$(NOECHO) $(ECHO) "license:             ~" >> META_new.yml
	$(NOECHO) $(ECHO) "author:              " >> META_new.yml
	$(NOECHO) $(ECHO) "    - Tim Bunce, Jeff Urlwin, Martin J. Evans mailto:dbi-users@perl.org" >> META_new.yml
	$(NOECHO) $(ECHO) "generated_by:        ExtUtils::MakeMaker version 6.42" >> META_new.yml
	$(NOECHO) $(ECHO) "distribution_type:   module" >> META_new.yml
	$(NOECHO) $(ECHO) "requires:     " >> META_new.yml
	$(NOECHO) $(ECHO) "    DBI:                           1.21" >> META_new.yml
	$(NOECHO) $(ECHO) "    Test::Simple:                  0.4" >> META_new.yml
...
disttest : distdir
	cd $(DISTVNAME) && $(ABSPERLRUN) Makefile.PL "LIBS=-LC:\strawberry\c\lib" "INC=-IC:\strawberry\c\include"
...
$(FIRST_MAKEFILE) : Makefile.PL $(CONFIGDEP)
	...
	$(PERLRUN) Makefile.PL "LIBS=-LC:\strawberry\c\lib" "INC=-IC:\strawberry\c\include"
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"1,15,0,0\">" > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <TITLE>$(DISTNAME)</TITLE>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <ABSTRACT>ODBC driver for the DBI module.</ABSTRACT>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>Tim Bunce, Jeff Urlwin, Martin J. Evans mailto:dbi-users@perl.org</AUTHOR>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <IMPLEMENTATION>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <DEPENDENCY NAME=\"DBI\" VERSION=\"1,21,0,0\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <DEPENDENCY NAME=\"Test-Simple\" VERSION=\"0,4,0,0\" />" >> $(DISTNAME).ppd
...
DBI_INSTARCH_DIR=C:\strawberry\perl\site\lib\auto\DBI
DBI_DRIVER_XST=C:\strawberry\perl\site\lib\auto\DBI\Driver.xst
...
$(BASEEXT).xsi: $(DBI_DRIVER_XST) C:\strawberry\perl\site\lib\auto\DBI\Driver_xst.h
