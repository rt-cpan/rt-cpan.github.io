...
carp "MSG=($msg)\n";
carp "proxyhost=($Net::SSLeay::proxyhost--$Net::SSLeay::proxyport)\n";
carp "auth=($Net::SSLeay::proxyauth--$Net::SSLeay::CRLF)\n";
...
carp "Socket Created!\n";
     ...
     if ($@) {
        # Should never happen, since this error is already handled in new().
        return $self->_croak_or_return (0, "Missing Perl Module Error:\n" . $@);
     }
     unless ( defined $socket ) {
